...
from tensorlayer.layers import InputLayer,Conv2d,ConcatLayer, BatchNormLayer, ElementwiseLayer, SubpixelConv2d,UpSampling2dLayer, FlattenLayer,DenseLayer,MaxPool2d
import time
...
def SRGAN_g(t_image0, t_image1, t_image2, t_image3, t_image4, is_train=False, reuse=False):
    ...
    with tf.variable_scope("SRGAN_g", reuse=reuse):
        ...
        n0 = InputLayer(t_image0, name='in0')
        n0 = Conv2d(n0, 64, (9, 9), (1, 1), padding='SAME', W_init=w_init, name='n64s1/n0')
        n1 = InputLayer(t_image1, name='in1')
        n1 = Conv2d(n1, 64, (9, 9), (1, 1), padding='SAME', W_init=w_init, name='n64s1/n1')
        n2 = InputLayer(t_image2, name='in2')
        n2 = Conv2d(n2, 64, (9, 9), (1, 1), padding='SAME', W_init=w_init, name='n64s1/n2')
        n3 = InputLayer(t_image3, name='in3')
        n3 = Conv2d(n3, 64, (9, 9), (1, 1), padding='SAME', W_init=w_init, name='n64s1/n3')
        n4 = InputLayer(t_image4, name='in')
        n4 = Conv2d(n4, 64, (9, 9), (1, 1), padding='SAME', W_init=w_init, name='n64s1/n4')
        n=ConcatLayer([n0,n1,n2,n3,n4],3)
